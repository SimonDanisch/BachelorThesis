...
The type system builds upon four basic components. Composite types, which are comparable to C structs, parametric composite types, bitstypes, abstract and parametric abstract types.
...
\begin{lstlisting}
foo{T}(x::Number, y::Complex{T}) = println("some number: ", x, " some complex Number: ", y) # shorthand function definition
