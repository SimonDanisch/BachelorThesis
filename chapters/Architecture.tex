...
It relies as much as it can on common Julia datatypes and creates specialized vizualisations for them via dispatch.
...
First, it makes it very easy to use for visual debugging, as any value can be displayed immidiately without any user interaction.
...
The next design goal was to make this fit for dynamic data, which resultet in relying on as little transformation of the data as possible and directly transfering it to the GPU.
...
These interactions can be purely programatically, or via the widgets from the edit function.
