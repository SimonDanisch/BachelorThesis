...
Volume renderings are not a trivial tasks, as it is already difficult to make a visualization which lets you peek inside a volume without discarding important informations\ref{fig:volumes}.
...
The ray marching rendering method was explicitely implemented for this thesis on the GPU. For the marching tedrahedra algorithm there was already a Julia implementation available in the package Meshes.jl. 
