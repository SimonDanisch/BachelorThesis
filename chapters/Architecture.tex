...
\begin{itemize}
	...
	\item Surfaces (Matrix of height values)
...
Though, there is only an edit function available for text fields, colors, numbers, vectors and matrices.
The edit functions calls the visualize function to render the data type and then registers events to update the data.
